...
namespace PetPlayApp.Test.Services
{
    ...
    public class PostServiceTests
    {
        ...
        public void Setup()
        {
            ...
            _postService = new PostService(_repositoryProviderMock.Object);
        }

        [Test]
        public void LikePost_ValidData_ReturnsPostDetailsDto()
        {
...
#pragma warning restore CS8600 // Testing null for nullable type
        ...
        [Test]
        public void UnlikePost_ValidData_ReturnsPostDetailsDto()
        {
            var postId = Guid.NewGuid();
            var userId = Guid.NewGuid();
            var user = new User { Id = userId };
